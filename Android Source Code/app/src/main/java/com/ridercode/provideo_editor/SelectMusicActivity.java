...
public class SelectMusicActivity extends ListActivity {
    ...
    static {
        ...
        sb.append("\"");
        i = new String[]{"_id", "_data", "title", "artist", "album", "duration", "_size", "is_ringtone", "is_alarm", "is_notification", "is_music"};
        StringBuilder sb2 = new StringBuilder();
        sb2.append("\"");
        sb2.append(Media.INTERNAL_CONTENT_URI);
        sb2.append("\"");
        j = new String[]{"_id", "_data", "title", "artist", "album", "duration", "_size", "is_ringtone", "is_alarm", "is_notification", "is_music"};
    }
        ...
        if (externalStorageState.equals("mounted_ro")) {
            ...
            try {
                ...
                try {
                    ...
                    MusicAdapter musicAdapter = new MusicAdapter(this, R.layout.select_music_row, a(""), new String[]{"artist", "album", "title", "duration", "_size"}, iArr);
                    this.a = musicAdapter;
