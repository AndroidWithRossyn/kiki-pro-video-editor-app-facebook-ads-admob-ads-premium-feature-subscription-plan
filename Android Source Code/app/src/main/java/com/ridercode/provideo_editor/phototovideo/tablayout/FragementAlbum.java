...
import com.ridercode.provideo_editor.phototovideo.DisplayAlbumActivity;
import com.ridercode.provideo_editor.phototovideo.model.AlbumImages;
import com.ridercode.provideo_editor.phototovideo.model.GallaryAlbum;
...
public class FragementAlbum extends Fragment {
    ...
    public class RecyclerGallaryAlbumAdapter extends Adapter<RecyclerGallaryAlbumAdapter.holder> {
        ...
        public holder onCreateViewHolder(ViewGroup viewGroup, int i) {
            return new holder(LayoutInflater.from(FragementAlbum.a).inflate(R.layout.p_tov_row_list_gallary, viewGroup, false));
        }
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        this.k = layoutInflater.inflate(R.layout.p_to_v_tab_album, viewGroup, false);
        a();
        return this.k;
    }
