package com.ridercode.provideo_editor.videowatermark.addtext;
...
import com.ridercode.provideo_editor.videowatermark.addtext.RecyclerItemClickListener.OnItemClickListener;
...
public class FragmentText extends Fragment {
    ...
    FontProvider d;
    List<String> e;
    int f = R.layout.video_w_fragment_empty;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        switch (this.h) {
            case 0:
                this.f = R.layout.video_w_fragment_empty;
                break;
            case 1:
                this.f = R.layout.video_w_fragment_texts;
                break;
            case 2:
                this.f = R.layout.video_w_fragment_text1;
                break;
            case 3:
                this.f = R.layout.video_w_fragment_text2;
                break;
        }
