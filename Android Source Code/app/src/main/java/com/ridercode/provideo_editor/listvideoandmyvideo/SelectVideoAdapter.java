package com.ridercode.provideo_editor.listvideoandmyvideo;
...
import com.ridercode.provideo_editor.videoconverter.VideoConverteractivity;
...
import com.ridercode.provideo_editor.videosplitter.VideoSplitterActivity;
...
public class SelectVideoAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        Glide.with(e).load(((VideoData) this.c.get(i)).videouri.toString()).into(aVar.a);
