package com.ridercode.provideo_editor.videotomp3;
...
public class VideoToMP3ConverterActivity extends AppCompatActivity {
    ...
    private void d() {
        ...
        String[] strArr = !this.g.equals("None")
                ? new String[]{"-y", "-i", this.h, "-vn", "-acodec", "copy", this.g, this.f, this.e, "-strict", "experimental", "-ss", valueOf, "-t", valueOf2, this.c}
                : this.d.equals("MP3") ? new String[]{"-y", "-i", this.h, "-vn", "-acodec", "copy", "-strict", "experimental", "-ss", valueOf, "-t", valueOf2, this.c} : this.d.equals("AAC") ? new String[]{"-y", "-ss", valueOf, "-t", valueOf2, "-i", this.h, "-vn", "-acodec", "copy", "-strict", "experimental", this.c} : null;
    ...
    private void a_api_24_plus(String[] strArr, final String str){
        ...
        this.progressDialog.setIndeterminate(G);
        ...
        try {
            ...
            this.fFmpeg.execute(strArr, new ExecuteBinaryResponseHandler() {
                ...
                public void onSuccess(String str) {
                    VideoToMP3ConverterActivity.this.progressDialog.dismiss();
                    if (VideoToMP3ConverterActivity.this.d.equals("MP3")) {
                        StringBuilder sb = new StringBuilder(String.valueOf(getExternalMediaDirs()[0].toString()));
                        sb.append("/VEditor/VideoToMP3/");
                        File file = new File(sb.toString());
