package com.ridercode.provideo_editor.videowatermark;
...
import com.ridercode.provideo_editor.VideoPlayerState;
...
import com.ridercode.provideo_editor.videowatermark.addtext.DataBinder;
import com.ridercode.provideo_editor.videowatermark.addtext.DrawableSticker;
import com.ridercode.provideo_editor.videowatermark.addtext.FragmentSticker;
import com.ridercode.provideo_editor.videowatermark.addtext.FragmentText;
import com.ridercode.provideo_editor.videowatermark.addtext.Sticker;
import com.ridercode.provideo_editor.videowatermark.addtext.StickerData;
import com.ridercode.provideo_editor.videowatermark.addtext.StickerView;
import com.ridercode.provideo_editor.videowatermark.addtext.StickerView.OnStickerOperationListener;
import com.ridercode.provideo_editor.videowatermark.addtext.TextSticker;
...
public class VideoWatermarkActivity extends AppCompatActivity {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (view == null) {
                try {
                    ...
                    try {
                        view2 = VideoWatermarkActivity.this.inflater.inflate(R.layout.video_w_sub_sticker_img_raw, null);
                        try {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.video_w_activity);
        ...
        if (H || supportActionBar != null) {
            ...
            k();
            StringBuilder sb = new StringBuilder();
            sb.append(getExternalMediaDirs()[0].toString());
            sb.append("/");
            ...
            if (this.bitmap1 == null) {
                try {
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append(getExternalMediaDirs()[0].toString());
                    sb2.append("/");
                    ...
                    sb3.append(getExternalMediaDirs()[0].toString());
                    sb3.append("/");
                    ...
                    AdsManager.loadInterstitialAd(VideoWatermarkActivity.this);
                    return;
                }
            } else {
                try {
                    StringBuilder sb4 = new StringBuilder();
                    sb4.append(getExternalMediaDirs()[0].toString());
                    sb4.append("/");
                    ...
                    sb5.append(getExternalMediaDirs()[0].toString());
                    sb5.append("/");
    ...
    private void a_api_24_plus(String[] strArr, final String str){
        ...
        long executionId = com.arthenica.mobileffmpeg.FFmpeg.executeAsync(strArr, (executionId1, returnCode) -> {
            if (returnCode == RETURN_CODE_SUCCESS) {
                Intent intent = new Intent("android.intent.action.MEDIA_SCANNER_SCAN_FILE");
                intent.setData(Uri.fromFile(new File(str)));
                VideoWatermarkActivity.this.sendBroadcast(intent);
    ...
    private void fgdfg() {
        ...
        viewGroup.addView(LayoutInflater.from(this).inflate(R.layout.video_w__view_pager_textsticker, viewGroup, false));
        ...
        smartTabLayout.setCustomTabView(new TabProvider() {
            public View createTabView(ViewGroup viewGroup, int i, PagerAdapter pagerAdapter) {
                View inflate = from.inflate(R.layout.video_w_custom_tabtext_sticker_layout, viewGroup, false);
    ...
    private void h() {
        ...
        viewGroup.addView(LayoutInflater.from(this).inflate(R.layout.video_w_custom_icons, viewGroup, false));
        ...
        this.ae.setCustomTabView(new TabProvider() {
            public View createTabView(ViewGroup viewGroup, int i, PagerAdapter pagerAdapter) {
                ImageView imageView = (ImageView) from.inflate(R.layout.video_w_custom_tab, viewGroup, false);
                switch (i) {
                    case 0:
